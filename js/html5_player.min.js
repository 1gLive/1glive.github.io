...
function initPlayer() {
	...
	if (printLog("initPlayer:: "), apiInfo.profiles.hasOwnProperty("low") ? defaultQuality = "low": apiInfo.profiles.hasOwnProperty("hd") ? defaultQuality = "hd": apiInfo.profiles.hasOwnProperty("high") ? defaultQuality = "high": apiInfo.profiles.hasOwnProperty("auto") && (defaultQuality = "low"), "live" == hpvars.videoType) initUrl = apiInfo.profiles[defaultQuality],
