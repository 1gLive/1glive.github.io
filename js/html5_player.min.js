...
function initPlayer() {
	...
	if (printLog("initPlayer:: "), apiInfo.profiles.hasOwnProperty("auto") ? defaultQuality = "auto": apiInfo.profiles.hasOwnProperty("hd") ? defaultQuality = "hd": apiInfo.profiles.hasOwnProperty("high") ? defaultQuality = "high": apiInfo.profiles.hasOwnProperty("low") , "live" == hpvars.videoType) initUrl = apiInfo.profiles[defaultQuality],
